	...
	<script>
		...
		$(function () {
			...
			$("#create-Stage").change(function () {
				...
				/*
				填写可能性
					pMap是Java语言中的键值对关系（Java中的map对象）
					将pMap转换为js中的键值对关系json
					var json = {"01资质审查":10,"02需求分析":25...};
				 */
				/*
				 现在不能以json.key的形式取得value
				 因为 stage是一个可变的变量
				 	使用的取值方式为json[key]
				 */
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="百度推广加广告">
				<input type="hidden" value="4d7a96ee7de047a89611de0155bcd72f" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="f4245eadf7ed4287b61456bbb97ad3f4" name="contactsId"/>
			</div>
		</div>
