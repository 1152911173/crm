				...
				<table class="table table-hover">
					...
					<tbody id="clueBody">
						<%--<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=bf4bf9886ab34e4ba3d18f40d0faee83';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
