...
<script type="text/javascript">
	$(function(){
		...
		//为提交按钮绑定事件，填充市场活动源（填写两项信息 市场活动名称+id）
		...
		$("#convertBtn").click(function () {
			...
			if($("#isCreateTransaction").prop("checked")){
				//需要创建交易，除了为后台传递clueId之外，还得传递交易表单中的信息，金额，预计成交日期，交易名称，阶段，市场活动源（id）
				//window.location.href = "workbench/clue/convert.do?flag=a&clueId=xxx&money=xxx";
				//以上传参方式很麻烦，表单扩充，挂载参数可能超出浏览器的上限
